...
namespace $ext_safeprojectname$.LoginUI
{
    ...
    public partial class LoginStatus : UserControl
    {
        ...
        private void Authentication_LoggedIn(object sender, OpenRiaServices.Client.Authentication.AuthenticationEventArgs e)
        {
            this.UpdateLoginState();
        }

        private void Authentication_LoggedOut(object sender, OpenRiaServices.Client.Authentication.AuthenticationEventArgs e)
        {
            this.UpdateLoginState();
        }
