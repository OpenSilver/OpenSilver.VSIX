...
Namespace Models
    ...
    Partial Public Class RegistrationData
        ...
        ''' </summary>
        <Display(AutoGenerateField:=False)>
        Public Property PasswordConfirmationAccessor As Func(Of String)
        ...
        ''' </summary>
        <Display(AutoGenerateField:=False)>
        Public Property CurrentOperation As OperationBase
            Get
        ...
        ''' </remarks>
        Public Sub UserNameEntered(userName As String)
